    ...
    <div className='channels-container'>
        ...
        <div className='all-server-channels'>
          {channels.map((channel, idx) => (
            <Link
              ...
              key={idx}
              to={`/channels/${guild_id}/${channel._id}`}
            >
              <svg
      ...
      <div className='channels-index-footer'>
        <div className='channels-index-footer-member-info'>
          <div className='guild-member-index-member-profile-picture'>
            <img
              className='small-logo-placeholder'
              src={user.profle_picture}
              alt=''
            />
          </div>
          <div className='channels-index-footer-name-id-container'>
            ...
            <div className='channels-index-footer-member-id'>#2020</div>
          </div>
        </div>
